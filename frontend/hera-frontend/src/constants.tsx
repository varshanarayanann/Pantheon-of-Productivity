...
export const GODDESSES: Goddess[] = [
  ...
  },
  {
    ...
    path: '/artemis',
    description: 'Domain of the wild, the hunt, and focus. Embrace the moon while enhancing your flow.',
    toolName: 'Night Mode',
    color: 'emerald',
  ...
  },
  {
    ...
    path: '/persephone',
    description: 'Domain of seasons, change, and growth. Set timers that flourish and evolve.',
    toolName: 'Seasonal Focus Timer',
    color: 'purple',
  ...
  },
  {
    ...
    toolName: 'Fresh Breaths of the Earth',
    color: 'lime',
